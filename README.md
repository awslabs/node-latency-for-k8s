...
```
curl -Lo 01-create-iam-policy.sh https://raw.githubusercontent.com/awslabs/node-latency-for-k8s/v0.1.9/scripts/01-create-iam-policy.sh
curl -Lo 02-create-service-account.sh https://raw.githubusercontent.com/awslabs/node-latency-for-k8s/v0.1.9/scripts/02-create-service-account.sh
...
wget https://github.com/awslabs/node-latency-for-k8s/releases/download/v0.1.9/node-latency-for-k8s_0.1.9_linux_${ARCH}.deb
dpkg --install node-latency-for-k8s_0.1.9_linux_${ARCH}.deb
```
...
```
[[ `uname -m` == "aarch64" ]] && ARCH="arm64" || ARCH="amd64"
rpm -i https://github.com/awslabs/node-latency-for-k8s/releases/download/v0.1.9/node-latency-for-k8s_0.1.9_linux_${ARCH}.rpm
```
...
wget -qO- https://github.com/awslabs/node-latency-for-k8s/releases/download/v0.1.9/node-latency-for-k8s_0.1.9_${OS}_${ARCH}.tar.gz | tar xvz
